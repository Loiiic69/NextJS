        ...
        <div className="mt-4 ml-10 flex justify-start items-start">
            <div>
                ...
                <div className="mt-4 flex gap-5">
                    <Link href="/send"className="shadow-2xl bg-white hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg flex items-center">
                        <Image  height={56} width={56} src="/icon6.png" alt="Send" className="h-6 w-6 mr-2" />
                        Send
                    </Link>
                    <button className="shadow-2xl bg-white hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg flex items-center">
                        <Image  height={56} width={56} src="/icon7.png" alt="Receive" className="h-6 w-6 mr-2" />
                        Receive
                    </button>
                    <button className="shadow-2xl bg-white hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg flex items-center">
                        ...
                ...
                <div className="mt-20 flex justify-between items-center">
                    ...
                    <Image height={56} width={56} src="/icon8.png" alt="Your Icon" className="h-20 w-20 ml-48 " />
                </div>
